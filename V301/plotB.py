...
L1plot = np.linspace(0.0018, 0.009) #Grenzen fuer linregr. guckt nach den Grenzwerten fuer die x-Werte.
...
plt.savefig('plotB.pdf') #erstellt und speichert automatisch den Plot als pdf datei