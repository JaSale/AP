...
#Einlesen der Daten
#Einfach Spalt
dEinzel, iEinzel = np.genfromtxt('Messung2.txt', unpack=True)
# Umrechnen in nA
iEinzel = (iEinzel-0.008)*10**(3) #in Ampere
dEinzel = (dEinzel - 24.7)*10**(-3)
...
paramsEinzel, covarianceEinzel = curve_fit(g, phiEinzel, iEinzel, p0=[30000 , 0.000075])
...
xEinzel = np.linspace(-0.021, 0.021, 10000)
plt.figure(1)
